      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link href="/category/business" className="px-3 py-2 rounded-md hover:bg-gray-100">
              Business
            </Link>
            <Link href="/category/technology" className="px-3 py-2 rounded-md hover:bg-gray-100">
              Technology
            </Link>
            <Link href="/category/health" className="px-3 py-2 rounded-md hover:bg-gray-100">
              Health
            </Link>
            <Link href="/category/science" className="px-3 py-2 rounded-md hover:bg-gray-100">
              Science
            </Link>
